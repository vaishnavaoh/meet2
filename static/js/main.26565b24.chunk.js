(this.webpackJsonpmeet = this.webpackJsonpmeet || []).push([
  [0],
  {
    28: function (e, t, n) {},
    29: function (e, t, n) {},
    ...
    51: function (e, t, n) {
      ...
      var o = n(1),
        ...
        m = (function (e) {
          ...
          function n(e) {
            ...
            return (
              Object(s.a)(this, n),
              ((o = t.call(this, e)).state = { showDetails: !1 }),
              o
            );
          }
          return (
              ...
              },
              {
                ...
                value: function () {
                  var e,
                    ...
                    a = n.description,
                    i = n.link,
                    s = this.props.event.start.dateTime;
                  return (
                    (e = this.state.showDetails
                      ? Object(d.jsxs)("div", {
                          className: "expanded",
                          children: [
                            Object(d.jsx)("h2", { children: "About event" }),
                            Object(d.jsx)("p", {
                            ...
                            Object(d.jsx)("a", {
                              className: "link",
                              href: i,
                              children: "See details on Google Calendar",
                            }),
                            Object(d.jsx)("button", {
                              className: "detailsButton",
                              onClick: function () {
                                return t.handleShowDetails(!1);
                              },
                    ...
                    Object(d.jsxs)("div", {
                      ...
                      children: [
                        ...
                        Object(d.jsx)("p", { className: "date", children: s }),
                        Object(d.jsx)("p", {
                          className: "location",
                          children: r,
                        }),
            ...
            Object(c.a)(n, [
              {
                ...
                value: function () {
                  if (!this.props.events)
                    return Object(d.jsx)("div", { className: "event-list" });
                  ...
                  return Object(d.jsx)("div", {
                    ...
                    children: Object(d.jsx)("ul", {
                      ...
                      children: e.map(function (e) {
                        return Object(d.jsx)(
                          "li",
                          { children: Object(d.jsx)(m, { event: e }) },
                          e.id
                        );
                      }),
                    }),
        ...
        g = (function (e) {
          ...
          function n(e) {
            ...
            return (
              Object(s.a)(this, n),
              ((o = t.call(this, e)).getStyle = function () {
        ...
        f = (function (e) {
          ...
          function n(e) {
            ...
            return (
              Object(s.a)(this, n),
              ((o = t.call(this, e)).getStyle = function () {
                return { color: o.color, fontWeight: "500", fontSize: "1em" };
              }),
              (o.color = "red"),
              o
            );
        ...
        y = (function (e) {
          ...
          function n() {
            ...
            return (
              ...
              (e.handleInputChanged = function (t) {
                var n = t.target.value,
                  o = e.props.locations.filter(function (e) {
                    return e.toUpperCase().indexOf(n.toUpperCase()) > -1;
                  });
                0 === o.length
                  ? e.setState({
                      query: n,
                      errorText: "No city was found under that search.",
                    })
                  : e.setState({ query: n, suggestions: o, errorText: "" });
              }),
              (e.handleItemClicked = function (t) {
                e.setState({ query: t, showSuggestions: !1, errorText: "" }),
                  e.props.updateEvents(t);
              }),
              e
            );
          }
            ...
            Object(c.a)(n, [
              {
                key: "listUpdate",
                value: function () {
                  var e = this.props.locations.filter(function (e) {
                    return e;
                  });
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return Object(d.jsxs)("div", {
                    ...
                    children: [
                      Object(d.jsx)(f, { text: this.state.errorText }),
                      Object(d.jsx)("input", {
                        type: "text",
                        className: "city",
                        ...
                        onFocus: function () {
                          e.listUpdate(), e.setState({ showSuggestions: !0 });
                        },
                        onBlur: function () {
                          e.setState({ showSuggestions: !1 });
                        },
                      }),
                      Object(d.jsxs)("ul", {
                        ...
                        children: [
                          ...
                          Object(d.jsx)("li", {
                            onMouseDown: function () {
                              return e.handleItemClicked("all");
                            },
        ...
        b = (function (e) {
          ...
          function n(e) {
            ...
            return (
              Object(s.a)(this, n),
              ((o = t.call(this, e)).handleInputChange = function (e) {
                ...
                t <= 0
                  ...
                  : o.setState({ eventListSize: t, errorText: "" }),
                  o.props.updateListSize(t);
              }),
              (o.state = { eventListSize: e.number, errorText: "" }),
              o
            );
          }
          return (
        ...
        T = [
          {
            ...
            creator: { email: "fullstackwebdev@careerfoundry.com", self: !0 },
            organizer: { email: "fullstackwebdev@careerfoundry.com", self: !0 },
            start: {
        ...
        M = n.n(D),
        x = function (e, t) {
          for (var n = [], o = 0; o < t; o++) e[o] && n.push(e[o]);
          return n;
        },
        W = function (e) {
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        (e.next = 3),
                        fetch(
                          "https://qqi6od00ej.execute-api.us-east-1.amazonaws.com/dev/api/token/" +
                            n
                        )
                          .then(function (e) {
                            return e.json();
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      ...
                      return (
                        (t = localStorage.getItem("lastEvents")),
                        M.a.done(),
                        e.abrupt("return", JSON.parse(t).events)
                      );
                    case 5:
                      if (
                        !window.location.href.startsWith("http://localhost")
                      ...
                      return M.a.done(), e.abrupt("return", T);
                    case 8:
                      return (e.next = 10), Y();
                    case 10:
                      if (!(n = e.sent)) {
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 6:
                      ...
                      return (
                        (e.next = 10), localStorage.removeItem("access_token")
                      );
                    case 10:
                      return (
                    ...
                    case 17:
                      return (
                        (a = e.sent),
                        (i = a.data.authUrl),
                        e.abrupt("return", (window.location.href = i))
                      );
                    case 20:
                      return e.abrupt("return", r && A(r));
                    case 21:
        ...
        U =
          ...
          (function (e) {
            ...
            function n() {
              ...
              return (
                Object(s.a)(this, n),
                ((e = t.call(this)).updateEvents = function (t) {
                  R().then(function (n) {
                    var o =
                        "all" === t || "" === t
                          ? n
                      ...
                      r = x(o, e.state.eventListSize);
                    e.setState({ events: o, limitedList: r });
                  });
                }),
                (e.updateListSize = function (t) {
                  var n = x(e.state.events, t);
                  e.setState({ eventListSize: t, limitedList: n });
                }),
                (e.state = {
                  events: [],
                  locations: [],
              ...
              Object(c.a)(n, [
                {
                  ...
                  value: function () {
                    ...
                    (this.mounted = !0),
                      R().then(function (t) {
                        if (e.mounted) {
                          var n = x(t, e.state.eventListSize);
                          e.setState({
                            events: t,
                            locations: W(t),
                            limitedList: n,
                ...
                },
                {
                  key: "render",
                  value: function () {
                    var e = this.state.limitedList,
                      t = "";
                    return (
                      navigator.onLine ||
                        (t =
                          "You are currently offline. Event list may not be current."),
                      Object(d.jsxs)("div", {
                        className: "App",
                        children: [
                          Object(d.jsx)(h, { text: t }),
                          Object(d.jsx)(y, {
      ...
      n(22).config("0858d06dfd8c4d0d9e4dd7fcf292927d").install(),
        i.a.render(
          Object(d.jsx)(r.a.StrictMode, { children: Object(d.jsx)(U, {}) }),
          document.getElementById("root")
        ),
        (function (e) {
          if ("serviceWorker" in navigator) {
            if (
              new URL("/meet2", window.location.href).origin !==
              window.location.origin
            )
              return;
            window.addEventListener("load", function () {
              var t = "".concat("/meet2", "/service-worker.js");
              q
                ? (!(function (e, t) {
...
//# sourceMappingURL=main.26565b24.chunk.js.map
